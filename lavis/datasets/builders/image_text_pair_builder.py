...
from lavis.datasets.datasets.vg_dense_caption_dataset import VGDenseCapDataset
...
# added by yzw
@registry.register_builder("vg_dense_caption")
class VGDenseCaptionBuilder(BaseDatasetBuilder):
    print("Here VGDenseCaptionBuilder")
    train_dataset_cls = VGDenseCapDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/vg/dense_caption.yaml"}
